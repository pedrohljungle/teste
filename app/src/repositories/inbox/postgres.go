...
func (r *postgresRepository) Insert(ctx context.Context, message *entities.InboxMessage) (inserted bool, err error) {
	ctx, end := r.obs.Start(ctx, observability.LayerRepository, "inbox.Repository.Insert")
	defer func() { end(err) }()
...
func (r *postgresRepository) Complete(ctx context.Context, message *entities.InboxMessage) (err error) {
	ctx, end := r.obs.Start(ctx, observability.LayerRepository, "inbox.Repository.Complete")
	defer func() { end(err) }()
...
func (r *postgresRepository) Find(ctx context.Context, consumerName, messageID string) (message *entities.InboxMessage, err error) {
